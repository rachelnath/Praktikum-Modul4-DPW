...
<body>
    ...
    style="background-color:rgb(155, 163, 187);">
        <div class="container">
    ...
    <!-- Cart -->
    <section class="bg-light h-100" style="background-color: rgb(234, 184, 221);">
        <div class="container h-100 py-5">
            <div class="row d-flex justify-content-between align-items-center">
                <div class="col-10">
                    ...
                    <!-- detail barang -->
                    <div class="card rounder-3 mb-4">
                        <div class="card-body p-4">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="col-md-2 col-lg-2 col-xl 2">
                                    <img src="/Pertemuan-03/assets/stationary.jpg" alt="Alat Tulis" class="img-fluid rounded-3">
                                </div>
                                <div class="col-md3 col-lg-3 col-xl-3">
                                    <p class="lead fw-normal mb-2">Alat Tulis</p>
                                    <p><span class="text-muted">Color: </span>Rainbow</p>
                                </div>
                                ...
                                <div class="col-md-3 col-lg-2 col-lx-2 offset-lg-1">
                    ...
                    <div class="d-grid gap-2">
                        <button class="btn btn-primary" type="button">Proceed Payment</button>
                    </div>
                    <!-- payment button end -->
